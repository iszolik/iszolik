...
Az installer automatikusan detektálja a Joomla default frontend template-jét az adatbázisból, így bármilyen template-tel működik (Cassiopeia, Protostar, Greenery, egyedi template-ek).
