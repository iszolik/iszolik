...
<div id="qvik-confirmation-container">
    <h2>Qvik Payment Confirmation</h2>
    <div id="qvik-status-message">Processing payment...</div>
</div>
...
(function() {
    ...
    function processPaymentConfirmation() {
        ...
        // Perform AJAX call
        document.getElementById('qvik-status-message').innerHTML = 
            '<div class="alert alert-info">Confirming payment with Qvik...</div>';
        ...
        .catch(function(error) {
            console.error('[Qvik] Payment confirmation error:', error);
            document.getElementById('qvik-status-message').innerHTML = 
