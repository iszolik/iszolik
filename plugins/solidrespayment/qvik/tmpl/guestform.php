...
/**
 * Qvik fizetési plugin vendég űrlap sablon
 * 
...
<div class="qvik-payment-form">
    <h3><?php echo JText::_('PLG_SOLIDRESPAYMENT_QVIK_GUEST_INFORMATION'); ?></h3>
    ...
    <div class="payment-actions">
        <button type="button" id="qvik-payment-btn" class="btn btn-primary">
            <?php echo JText::_('PLG_SOLIDRESPAYMENT_QVIK_PROCEED_TO_PAYMENT'); ?>
        </button>
        <button type="button" id="qvik-cancel-btn" class="btn btn-default">
