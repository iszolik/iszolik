<?php
/**
 * Revolut Fizetési Plugin - Guest Form Template
 * 
...
<div id="sr-guest-form">
    <form id="revolut-guest-form" method="post" class="form-horizontal">
...
(function() {
    ...
    function handleGuestFormSubmit(event) {
        ...
        var form = document.getElementById('revolut-guest-form');
