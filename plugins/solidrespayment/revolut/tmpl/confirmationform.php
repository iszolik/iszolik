...
/**
 * Revolut fizetési plugin - Megerősítő űrlap sablon
 * 
 * Ez a fájl tartalmazza a fizetés véglegesítő űrlapját, amely a Revolut fizetési
...
?>
<div class="revolut-payment-confirmation">
    ...
    <!-- Fizetési űrlap -->
    <form id="revolutPaymentForm" method="post" action="">
        <!-- Rejtett mezők a Revolut gateway számára -->
...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var form = document.getElementById('revolutPaymentForm');
        var paymentBtn = document.getElementById('paymentBtn');
        
        if (!form) {
            console.error('Revolut payment form not found');
            return;
        }
         ...
         * 
         * Ha a Revolut gateway átirányít vissza az oldalra (pl. 3D Secure után),
