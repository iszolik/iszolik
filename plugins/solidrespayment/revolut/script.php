...
/**
 * Revolut Payment Plugin Installer Script
 */
class plgSolidrespaymentRevolutInstallerScript
{
     ...
     */
    const PLUGIN_MARKER = '; === REVOLUT PAYMENT PLUGIN - START ===';
    ...
    public function postflight($type, $parent)
    {
        if ($type === 'install' || $type === 'update')
        {
            try
            {
                ...
                echo '<div class="alert alert-success">Revolut plugin sikeresen telepítve!</div>';
            }
            catch (\Exception $e)
            {
    ...
    {
        echo '<div class="alert alert-info">Revolut plugin eltávolítva. A módosított fájlok megmaradtak.</div>';
        return true;
    }
