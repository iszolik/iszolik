<?php
/**
 * Solidres ReservationAsset Controller
 * 
 * Enhanced controller with session-based validation for payment methods.
 * This fixes 404 errors in submenu contexts by using session validation
 * as primary authentication instead of strict menu context validation.
 * 
 * @package     Solidres
